...
INTERNAL_IPS = ( '127.0.0.1', '97.78.101.11')
logging.basicConfig(
    #level=logging.DEBUG if DEBUG else logging.INFO,
    level=logging.DEBUG,
    filename=PROJECT_DIR + 'djdns.log',
)
...
SECRET_KEY = '4+h^=n%%xcnie5++8082d9*dgap+mh8yn6m0mox2hc5m2zj5#u'
...
INCOMING_ZONEFILE_DIR = os.path.join(MEDIA_ROOT, 'incoming')
